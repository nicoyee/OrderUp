...
import CreateEvent from "./StaffEventsCreateEvent";
...
const StaffEvents = () => {
    ...
    const handleEditConfirm = async (eventId) => {
        try {
            ...
            await Staff.updateEvent(eventId, updatedEventData);
    ...
    return (
        <div id="staffEvents" className="dashboard-content">
