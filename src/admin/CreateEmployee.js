...
const ManageUsers = ({ closeModal }) => {
    ...
    return (
        <form id='createEmployee' className="modalForm" onSubmit={ handleSignUp }>
            <div className='modalForm-header'>
                ...
                <h2>Having an employee account gives your people access to additional features</h2>
            </div>
            ...
            <div className='adminForm-section'>
                ...
                <div className='adminForm-input'>
                    ...
                    <input type="email" placeholder="Enter employee Email" value = { email } onChange={(e)=>setEmail(e.target.value)}/>
                </div>
            </div>
            <div className='adminForm-section'>
                ...
                <div className='adminForm-input'>
                    ...
                    <input type={ passwordShown ? 'text' : 'password' } placeholder="Enter employee Password" value = { password } onChange={(e)=>setPassword(e.target.value)} />
                ...
                <button className="adminForm-submit">Sign Up Employee</button>
            </div>
        </form>
    );
};
