...
class CartController {
    ...
    static async getBestSellers() {
        try {
            ...
            // Update or add items with count >= 20 to the best_sellers collection
            for (const dishId in dishCountMap) {
                ...
                if (count >= 20) {
                    ...
                    if (dishDoc.exists()) {
                        ...
                        // Add or update in the best_sellers collection only if not already present
                        if (!existingBestSellers[dishId] || existingBestSellers[dishId].count !== count) {
            ...
            // Return the updated list of best sellers (without limit)
            return updatedBestSellers;
        } catch (error) {
