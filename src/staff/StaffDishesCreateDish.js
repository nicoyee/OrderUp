...
const StaffDishesCreateDish = ({ closeCreateDish, setDishes }) => {
    ...
    const handleCreateDish = async (e) => {
        ...
        try {
            const newDish = await Staff.createDish(name, menuType, description, numericPrice, photo);
    ...
    return (
        <form id="staffDishesCreateDish" className="modal form" onSubmit={ handleCreateDish }>
...
export default StaffDishesCreateDish;
